function Isosurfaces( volume, isovalue )
{
        ...
        for ( var y = 0; y < volume.resolution.y - 1; y++ )
        {
            for ( var x = 0; x < volume.resolution.x - 1; x++ )
            {
                ...
                for ( var j = 0; lut.edgeID[index][j] != -1; j += 3 )
                {
                    ...
                    var v01 = interpolated_vertex( v0, v1, isovalue ,vid0, vid1);
                    var v23 = interpolated_vertex( v2, v3, isovalue ,vid2, vid3);
                    var v45 = interpolated_vertex( v4, v5, isovalue ,vid4, vid5);
    ...
    function interpolated_vertex( v0, v1, s ,vid0, vid1)
    {
